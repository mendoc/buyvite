            ...
            <div className="mt-5">
                ...
                <form className="mt-5" onSubmit={handleSubmit}>
                    <div className="mt-3">
                        ...
                        <input name="name" onChange={handleChange} className="border w-full px-2 py-1 outline-none" type="text" placeholder="Ex : Montre en rafia" />
                    </div>
                    <div className="mt-3">
                        <label className="font-bold text-blue-900">Lien de l'image</label>
                        <input name="image" onChange={handleChange} className="border w-full px-2 py-1 outline-none" type="url" placeholder="Ex : https://www.siteimage.com/montrerafia.jpg" />
                    </div>
                    <div className="mt-3">
                        <label className="font-bold text-blue-900">Prix du produit</label>
                        <input name="price" onChange={handleChange} className="border w-full px-2 py-1 outline-none" type="number" placeholder="Ex : 13500" min="200" max="100000" />
                    </div>
                    <div className="mt-3">
